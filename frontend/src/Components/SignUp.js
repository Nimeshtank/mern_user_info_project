            ...
            <div className='signup-form'>
              ...
              <form method='POST' className='register-form' id='register-form'>
                ...
                <div className='form-input'>
                  ...
                  <input type="text" id="email" autoComplete='off' placeholder='Your Email' name='email' className='form-input-element' value={user.email} onChange={handleInputs} />
                </div>
                <div className='form-input'>
                  <label htmlFor='phone'>
                    <i className="zmdi zmdi-smartphone-android"></i>
                  </label>
                  <input type="text" id="phone" autoComplete='off' placeholder='Phone Number' name='phone' className='form-input-element' value={user.phone} onChange={handleInputs} />
                </div>
                <div className='form-input'>
                ...
                <div className='form-input'>
                  ...
                  <input type="text" id="password" autoComplete='off' placeholder='Your Password' name='password' className='form-input-element' value={user.password} onChange={handleInputs} />
                </div>
                <div className='form-input'>
                  <label htmlFor='cpassword'>
                    <i className="zmdi zmdi-lock"></i>
                  </label>
                  <input type="text" id="cpassword" autoComplete='off' placeholder='Confirm Password' name='cpassword' className='form-input-element' value={user.cpassword} onChange={handleInputs} />
                </div>
